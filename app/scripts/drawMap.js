define(['leaflet', 'jquery', 'topojson', './asia', 'json!../data/asia-topo.json'], function (L, $, topojson, asia, asiaTopo) {
    'use strict';
    ...
    var init = function () {
        ...
        var asiaGeoJson = topojson.feature(asiaTopo, asiaTopo.objects.asia);
        countriesLayer.addData(asiaGeoJson);
        info.addTo(map);
